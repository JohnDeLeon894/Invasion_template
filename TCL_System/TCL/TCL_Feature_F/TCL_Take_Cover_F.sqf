...
TCL_Take_Cover_F = [
	...
	if (alive _enemy) then
	{
		...
		if (isNil "_array") then
		{
			...
			_string = format ["%1<t align='center'>Ups...!<br/>Something went wrong in TCL %2...<br/>Don't worry the problem will be solved as soon as this message appears.<br/>Please help me fix this issue by reporting the line stored in your .rpt file!</t>", (TCL_Text_F select 5), name player];
